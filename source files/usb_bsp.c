...
#define HOST_OTG_POWERSW_PORT_RCC          RCC_AHB1Periph_GPIOB
#define HOST_OTG_POWERSW_PORT              GPIOB
#define HOST_OTG_POWERSW_VBUS              GPIO_Pin_9
...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
 /* Note: On STM32F4-Discovery board only USB OTG FS core is supported. */
  ...
  RCC_AHB1PeriphResetCmd( RCC_APB1Periph_PWR, ENABLE) ;  
   #endif    
  #endif
 #endif //USB_OTG_HS
...
//    GPIO_SetBits(HOST_POWERSW_PORT, HOST_POWERSW_VBUS);
    ...
    GPIO_ResetBits(HOST_OTG_POWERSW_PORT, HOST_OTG_POWERSW_VBUS);        
  }
  else
  {
...
//    GPIO_ResetBits(HOST_POWERSW_PORT, HOST_POWERSW_VBUS);
    GPIO_SetBits(HOST_POWERSW_PORT, HOST_POWERSW_VBUS);    
    GPIO_SetBits(HOST_OTG_POWERSW_PORT, HOST_OTG_POWERSW_VBUS);        
  }
}
...
void  USB_OTG_BSP_ConfigVBUS(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  GPIO_InitStructure.GPIO_Pin =HOST_POWERSW_VBUS | HOST_OTG_POWERSW_VBUS;     
  ...
  GPIO_ResetBits(HOST_POWERSW_PORT, HOST_OTG_POWERSW_VBUS);
